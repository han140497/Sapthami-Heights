-- Migration: 20260728000300_fix_reset_invoices.sql
-- Fix reset_all_test_data to omit update on invoices.journal_entry_id which does not exist.
...
as $$
begin
  -- 1. Unlink FKs on operational tables (payments, expenses, water_purchases)
  ...
  update water_purchases set journal_entry_id = null where journal_entry_id is not null;
